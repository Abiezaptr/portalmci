    ...
    <div class="page-content page-2">
        <div class="comment-section">
            <div class="reaction-icons">
                ...
                <button class="btn btn-sm btn-light mr-3 position-relative">
                    <i class="fa-regular fa-comment"></i>
                    <span class="badge badge-pill badge-danger" style="position: absolute; top: -10px; right: -10px;">9</span>
                </button>
            </div>
        </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="comment-item d-flex align-items-center">
                            <img src="<?= base_url('assets/images/carol.png') ?>" alt="Author" class="author-image" style="border-radius: 50%; width: 40px; height: 40px; margin-right: 10px;">
                            <div>
                                <span class="comment-text">mantap artikel yang sangat bermanfaat untuk pengguna 👍 👍 👍</span>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="card mt-2">
                    <div class="card-body">
                        <div class="comment-item d-flex align-items-center">
                            ...
                            <div>
                                <span class="comment-text">Artikel yang sangat berguna</span>
                            </div>
                        </div>
                    </div>
                </div>
                <br>
                <a href="#" style="color: #007BFF; text-decoration: underline;">9 Komentar</a>
            </div>
        </div>
    </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body text-center">
                    ...
                    <div class="d-flex justify-content-center">
                        <a href="#" class="btn btn-outline-primary btn-circle mx-2">
                            <i class="fab fa-facebook"></i>
                        </a>
                        <a href="#" class="btn btn-outline-dark btn-circle mx-2">
                            <i class="fab fa-twitter"></i>
                        </a>
                        <a href="#" class="btn btn-outline-success btn-circle mx-2">
                            <i class="fab fa-whatsapp"></i>
                        </a>
                        <a href="#" class="btn btn-outline-secondary btn-circle mx-2">
