...
<div class="container-fluid d-flex justify-content-center">
    ...
    <div class="card shadow mb-4" style="width: 80%;">
        <div class="card-header py-3 d-flex justify-content-between align-items-center">
            <!-- Title on the left -->
            <h6 class="m-0 font-weight-bold" style="color: maroon;">Add Digital Report</h6>
        ...
        <div class="card-body">
            <form action="<?= site_url('insert/digital-report'); ?>" method="POST" enctype="multipart/form-data">
