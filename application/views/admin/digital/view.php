                                     ...
                                     <tr>
                                         ...
                                         <td>
                                             <div style="border: 1px solid #ffc107; border-radius: 5px; padding: 5px; background-color: #fff3cd; color: #856404;">
                                                 <center> <strong>Digital Insight</strong>
                                             </div>
                                         </td>
                                         <td>
                                         ...
                                         <td>
                                             ...
                                             <div class="dropdown">
                                                 ...
                                                 <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                     <a class="dropdown-item" href="<?= site_url('update/digital-report/' . $report['id']); ?>">Update</a>
                                                     <?php if ($this->session->userdata('role') == 1) : ?>
                                                         <div class="dropdown-divider" style="border-top: 1px dashed #ccc; margin: 5px 0;"></div>
                                                         <a class="dropdown-item" href="<?= site_url('delete/digital-report/' . $report['id']); ?>">Remove</a>
                                                     <?php endif; ?>
                                                 </div>
                                             </div>
                                         </td>
