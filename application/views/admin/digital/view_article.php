     ...
     <div class="container-fluid">
         ...
         <div class="card shadow mb-4">
             <div class="card-header py-3 d-flex justify-content-between align-items-center">
                 <!-- Title on the left -->
                 <h6 class="m-0 font-weight-bold" style="color: maroon;">DIGITAL ARTICLES LIST</h6>
                                     ...
                                     <tr>
                                         ...
                                         <td>
                                             <div style="border: 1px solid #ffc107; border-radius: 5px; padding: 5px; background-color: #fff3cd; color: #856404;">
                                                 <center> <strong>Digital Insights</strong>
                                             </div>
                                         </td>
                                         <td>
                                             ...
                                             <div class="dropdown">
                                                 ...
                                                 <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                     ...
                                                     <?php if ($this->session->userdata('role') == 1) : ?>
                                                         ...
                                                         <a class="dropdown-item" href="<?= site_url('delete/digital-article/' . $report['id']); ?>">Remove</a>
                                                     <?php endif; ?>
                                                 </div>
                                             </div>
                                         </td>
