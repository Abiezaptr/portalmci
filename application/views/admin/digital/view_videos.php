     ...
     <div class="container-fluid">
         ...
         <div class="card shadow mb-4">
             <div class="card-header py-3 d-flex justify-content-between align-items-center">
                 <!-- Title on the left -->
                 <h6 class="m-0 font-weight-bold" style="color: maroon;">Digital Insight Videos</h6>
                                     ...
                                     <tr>
                                         ...
                                         <td>
                                             ...
                                             <?php if ($this->session->userdata('role') == 1) : ?>
                                                 <a href="<?= site_url('delete/digital-videos/' . $video['id']); ?>" class="btn btn-sm"><i class="fa fa-trash-alt" style="color: maroon;"></i></a>
                                             <?php endif; ?>
                                         </td>
                                     </tr>
                                 <?php endforeach; ?>
     ...
     <div class="modal fade" id="addVideosModal" tabindex="-1" role="dialog" aria-labelledby="addVideosModalLabel" aria-hidden="true">
         <div class="modal-dialog modal-lg modal-dialog-centered" role="document"> <!-- Added modal-dialog-centered -->
             <div class="modal-content">
                 ...
                 <form id="categoryForm" action="<?= site_url('insert/digital-videos'); ?>" method="post">
         ...
         <div class="modal fade" id="updateVideoModal<?= $video['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="updateVideoModalLabel" aria-hidden="true">
             <div class="modal-dialog modal-lg modal-dialog-centered" role="document"> <!-- Added modal-dialog-centered -->
                 <div class="modal-content">
                     ...
                     <form id="categoryForm<?= $video['id']; ?>" action="<?= site_url('update/digital-videos/' . $video['id']); ?>" method="post">
                         <div class="modal-body">
                             <div class="row">
                                 <div class="col-md-12">
                                     <div class="form-group">
