...
<div class="container-fluid d-flex justify-content-center">
    ...
    <div class="card shadow mb-4" style="width: 80%;">
        <div class="card-header py-3 d-flex justify-content-between align-items-center">
            <!-- Title on the left -->
            <h6 class="m-0 font-weight-bold" style="color: maroon;">Add Fixed Report</h6>

            <!-- Back button on the right -->
            <a href="<?= site_url('fixed-report') ?>" class="btn btn-danger btn-sm btn-icon-split">
        ...
        <div class="card-body">
            <form action="<?= site_url('insert/fixed-report'); ?>" method="POST" enctype="multipart/form-data">
